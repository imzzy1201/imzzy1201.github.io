...
Elm.UkkonenVisualization.make = function (_elm) {
   ...
   var view = function (model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("")]))
                      // ,introText
                      ,A2($Html.div,
                              ...
                              ,function () {
                                 ...
                                 if (_p17.ctor === "Just") {
                                       ...
                                       _U.list([A2($Html.li,
                                               ...
                                               ,A2($Html.li,
                                               _U.list([]),
                                               _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("active_rem:")]))
                                                       ,A2($Html.span,
                                                       _U.list([$Html$Attributes.id("var-active-length")]),
                                                       _U.list([$Html.text(activeLengthString)]))]))
                                               ,A2($Html.li,
                                               _U.list([]),
                                               _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("active_char:")]))
                                                       ,A2($Html.span,
